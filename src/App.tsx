...
function SunIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M6.76 4.84 5.34 3.41 3.93 4.83l1.42 1.42 1.41-1.41Zm10.49 0 1.41-1.43 1.42 1.42-1.42 1.42-1.41-1.41ZM12 6a6 6 0 1 1 0 12 6 6 0 0 1 0-12Zm0-4h-1v3h2V2h-1Zm0 17h-1v3h2v-3h-1ZM2 13h3v-2H2v2Zm17 0h3v-2h-3v2Zm-1.76 6.16 1.42 1.43 1.41-1.42-1.41-1.42-1.42 1.41Zm-10.49 0-1.41 1.43-1.42-1.42 1.42-1.42 1.41 1.41Z" />
    </svg>
  );
}
